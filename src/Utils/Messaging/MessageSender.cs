...
namespace Utils.Messaging
{
    ...
    {
        private static readonly Meter MyMeter = new(nameof(MessageSender), "1.0");
        private static readonly Counter<long> MessagesPublished = MyMeter.CreateCounter<long>("demo_otel_messages_published","messages", "Total message published");
