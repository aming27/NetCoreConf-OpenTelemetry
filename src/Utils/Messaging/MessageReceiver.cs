...
namespace Utils.Messaging
{
    ...
    {
        private static readonly Meter MyMeter = new(nameof(MessageReceiver), "1.0");
        private static readonly Counter<long> MessagesReceived = MyMeter.CreateCounter<long>("demo_otel_messages_received", "messages", "Total message received");
